...
仓库包含 iPhone 原生工程：模型与学习资料随包安装，核心图谱在使用者自己的设备上运行。当前提供开发与未签名构建流程，尚无可直接安装的公开 iPhone 安装包，也未提交 App Store 审核。详见 [iPhone 构建指南](docs/IOS.md)、[隐私说明](docs/IOS-PRIVACY.md)及[上架准备材料](docs/IOS-SUBMISSION.md)。
